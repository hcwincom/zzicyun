 ...
 */
class GoodsbaseController extends AdminInfoController
{
    ...
    public function add_do()
    {
        ...
        foreach($fields as $k=>$v){
            if(isset($data[$k])){
                switch($v){
                    case 'int':
                        $data_add[$k]=intval($data[$k]);
                        break;
                    case 'round1':
                        $data_add[$k]=round($data[$k],1);
                        break;
                    case 'round2':
                        $data_add[$k]=round($data[$k],2);
                        break;
                    case 'round3':
                        $data_add[$k]=round($data[$k],3);
                        break;
                    case 'round4':
                        $data_add[$k]=round($data[$k],4);
                        break;
                    default:
                        $data_add[$k]=$data[$k];
                        break;
