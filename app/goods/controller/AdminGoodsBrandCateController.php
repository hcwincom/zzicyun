...
/* 产品品牌分类 */
class AdminGoodsBrandCateController extends AdminInfoController
{
    ...
    public function _initialize()
    {
        ...
        $this->flag='产品品牌分类';
        $this->table='goods_brand_cate';
        $this->m=Db::name('goods_brand_cate');
